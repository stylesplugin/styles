...
class Styles_Child_Theme extends Styles_Child_Updatable {
	...
	public function is_active() {
		...
		if (    $this->theme_name_equals_plugin_item_name( $this->theme )
			   || $this->theme_name_equals_plugin_item_name( $this->theme->parent() )
		) {
			return true;
		}

		// Do parent or child theme header name == Styles plugin header name?
		if (    $this->theme_name_equals_plugin_name( $this->theme )
			   || $this->theme_name_equals_plugin_name( $this->theme->parent() )
		) {
			return true;
		}

		// Does the parent or child directory name == Styles directory name?
		if (    $this->theme_directory_name_equals_plugin_directory_name( $this->theme )
			   || $this->theme_directory_name_equals_plugin_directory_name( $this->theme->parent() )
		) {
			return true;
		}
