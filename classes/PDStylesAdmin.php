...
class StormStylesAdmin extends StormStyles {
	...
	function admin_css() {
		...
		wp_enqueue_style ( 'storm-admin' , apply_filters ( 'storm-admin-css' , '/?scaffold&file=css/admin.css' ) , array('storm-colorpicker') , $this->version , 'screen' );
	}
